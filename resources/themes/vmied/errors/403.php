...
<div class="min-h-[50vh] flex flex-col items-center justify-center text-center">
    <div class="text-9xl font-black text-slate-200">403</div>
    ...
    <a hx-get="/" hx-target="[data-eclo-content='eclo']" hx-push-url="true" class="mt-8 px-6 py-3 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition">
